...
bool gen_chain_switch_1::generate(std::vector<test_event_entry>& events) const
{
  ...
  */
  ...
  MAKE_TX(events, tx_00, miner_account, recipient_account_1, 500000000, blk_0);                 //  5 + N
  ...
  MAKE_TX_LIST_START(events, txs_blk_3, miner_account, recipient_account_2, 700000000, blk_2);  //  8 + 2N
  MAKE_TX_LIST_START(events, txs_blk_4, miner_account, recipient_account_3, 1100000000, blk_2); //  9 + 2N
  MAKE_TX_LIST_START(events, txs_blk_5, miner_account, recipient_account_4, 1300000000, blk_2); // 10 + 2N
  ...
  MAKE_TX_LIST(events, txs_blk_3, miner_account, recipient_account_1, 100000000, blk_2);        // 11 + 2N
  txs_blk_5.push_back(txs_blk_3.back());
  MAKE_TX_LIST(events, txs_blk_3, miner_account, recipient_account_1, 200000000, blk_2);        // 12 + 2N
  txs_blk_6.push_back(txs_blk_3.back());

  MAKE_TX_LIST(events, txs_blk_3, miner_account, recipient_account_2, 100000000, blk_2);        // 13 + 2N
  txs_blk_5.push_back(txs_blk_3.back());
  MAKE_TX_LIST(events, txs_blk_4, miner_account, recipient_account_2, 200000000, blk_2);        // 14 + 2N
  txs_blk_5.push_back(txs_blk_4.back());

  MAKE_TX_LIST(events, txs_blk_3, miner_account, recipient_account_3, 100000000, blk_2);        // 15 + 2N
  txs_blk_6.push_back(txs_blk_3.back());
  MAKE_TX_LIST(events, txs_blk_4, miner_account, recipient_account_3, 200000000, blk_2);        // 16 + 2N
  txs_blk_5.push_back(txs_blk_4.back());

  MAKE_TX_LIST(events, txs_blk_4, miner_account, recipient_account_4, 100000000, blk_2);        // 17 + 2N
  txs_blk_5.push_back(txs_blk_4.back());
  MAKE_TX_LIST(events, txs_blk_3, miner_account, recipient_account_4, 200000000, blk_2);        // 18 + 2N
  txs_blk_6.push_back(txs_blk_3.back());
...
bool gen_chain_switch_1::check_split_not_switched(CryptoNote::Core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
  ...
  CHECK_TEST_CONDITION(r);
  CHECK_EQ(800000000,  get_balance(m_recipient_account_1, chain, mtx));
  CHECK_EQ(1000000000, get_balance(m_recipient_account_2, chain, mtx));
  CHECK_EQ(1400000000, get_balance(m_recipient_account_3, chain, mtx));
  CHECK_EQ(300000000,  get_balance(m_recipient_account_4, chain, mtx));
  ...
  CHECK_EQ(1300000000, transfered);
...
bool gen_chain_switch_1::check_split_switched(CryptoNote::Core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
  ...
  CHECK_TEST_CONDITION(r);
  CHECK_EQ(800000000,  get_balance(m_recipient_account_1, chain, mtx));
  CHECK_EQ(300000000,  get_balance(m_recipient_account_2, chain, mtx));
  CHECK_EQ(1400000000, get_balance(m_recipient_account_3, chain, mtx));
  CHECK_EQ(1600000000, get_balance(m_recipient_account_4, chain, mtx));
