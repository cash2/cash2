...
bool gen_simple_chain_split_1::generate(std::vector<test_event_entry> &events) const
{
  ...
  */
  ...
  MAKE_TX(events, tx_0, first_miner_account, alice, 100000000, blk_23);                    //  N1+1
  MAKE_TX(events, tx_1, first_miner_account, alice, 200000000, blk_23);                    //  N1+2
  MAKE_TX(events, tx_2, first_miner_account, alice, 300000000, blk_23);                    //  N1+3
